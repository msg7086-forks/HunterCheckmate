...
{
	AnimalGroup::AnimalGroup(AnimalType animal_type, uint32_t index, uint32_t spawn_area_id, std::vector<Animal> animals)
		: m_animal_type(animal_type), m_index(index), m_spawn_area_id(spawn_area_id), m_animals(std::move(animals))
	{
